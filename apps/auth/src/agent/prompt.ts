...
export function generateSystemPrompt(options: {
  ...
  return [
    ...
    "Valid examples:",
    "```openui",
    "root = Stack([metrics, table])",
    'metrics = MetricGroup([{"label": "Total Pipeline", "value": "$1,500,000"}, {"label": "Closed Won", "value": "$0"}])',
    'table = DataTable([{"key": "title", "header": "Deal Title"}, {"key": "stage", "header": "Stage"}, {"key": "value", "header": "Value"}], [{"title": "Acme Redesign", "stage": "Proposal Sent", "value": "$50,000"}])',
    "```",
    "Component Spec:",
    specJson,
  ].join("\n")
