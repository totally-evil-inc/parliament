...
const IMMUTABLE_CORE_CONTRACT = [
  ...
  "- When calling `ask_clarifying_questions`, always include a brief, helpful conversational message (e.g. 'Please answer a few questions below so I can tailor the proposal for you:'). DO NOT reproduce the list of questions in markdown chat text and DO NOT emit OpenUI blocks; the interactive questionnaire form widget will render directly below.",
