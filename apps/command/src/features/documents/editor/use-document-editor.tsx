...
import { editorCommands, slashMenuCommands } from "@/lib/editor/commands"
...
export function useDocumentEditor({
  ...
  const resolvedPlaceholder =
    definition?.placeholder ?? placeholder ?? "Press '/' for commands..."
  const resolvedExtensions = definition
    ? [
    ...
    : extensions
  const resolvedCommands = definition
  ...
  const editor = useEditor(
    {
      extensions: [
        ...
        SlashCommand.configure({ commands: resolvedCommands }),
      ],
      content,
