import type { InsertDocumentBlockOptions } from "@/features/documents/editor/types"

const EDITABLE_SPACER = { type: "paragraph" }

function findTopLevelNodePosition(editor: InsertDocumentBlockOptions["editor"], type: string) {
  let position = 0
