...
export function TestimonialsView({ node }: NodeViewProps) {
  const columnCount = columns(node.attrs.columns)

  return (
    <NodeViewWrapper
      className={`testimonials proposal-grid-block ${gridColumnClassNames[columnCount]} my-[var(--document-section-spacing)] w-full outline-none`}
    >
