...
export function createBaseEditorCommands(
  ...
  return [
    ...
    },
    {
      ...
      icon: IconBulletList as IconComponent,
      group: "block",
      showInBubbleMenu: true,
      showInSlashMenu: true,
      showInFloatingMenu: true,
    ...
    },
    {
      ...
      icon: IconHelpChat as IconComponent,
      group: "block",
      showInBubbleMenu: true,
      showInSlashMenu: true,
      showInFloatingMenu: true,
    ...
    },
    {
      ...
      icon: IconCircleArrowRight as IconComponent,
      group: "block",
      showInBubbleMenu: true,
      showInSlashMenu: true,
      showInFloatingMenu: true,
    ...
    },
    {
      ...
      icon: IconGrid2 as IconComponent,
      group: "block",
      showInSlashMenu: true,
      showInFloatingMenu: true,
      command: ({ editor, range }) => {
    ...
    },
    {
      ...
      icon: IconHammer as IconComponent,
      group: "block",
      showInBubbleMenu: true,
      showInSlashMenu: true,
      showInFloatingMenu: true,
    ...
    },
    {
      ...
      icon: IconArrowBoldDown as IconComponent,
      group: "block",
      showInBubbleMenu: true,
      showInSlashMenu: true,
      showInFloatingMenu: true,
    ...
    },
    {
      ...
      icon: IconCodeEditor as IconComponent,
      group: "block",
      showInBubbleMenu: true,
      showInSlashMenu: true,
      showInFloatingMenu: true,
