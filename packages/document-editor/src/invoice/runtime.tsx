...
import type { InvoiceDraftStore } from "../runtime/store"
import { useDocumentEditor } from "../runtime/use-document-editor"
import { invoiceEditorRegistry } from "./registry"

export function useInvoiceEditorRuntime({
  debounceMs = 300,
...
export type InvoiceEditorRuntime = ReturnType<typeof useInvoiceEditorRuntime>
